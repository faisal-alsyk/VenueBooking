...
router.post('/', validation.createBooking, middleware.publicRoutes, bookingController.createBooking);
...
router.post('/:id', middleware.publicRoutes, bookingController.deleteBooking);
